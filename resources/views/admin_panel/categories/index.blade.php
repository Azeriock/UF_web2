            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" id="cat_form">
                        ...
                        <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Categorie</label>
                            <div class="col-sm-9">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.categories.edit', ['id' => $cat->id])}}" class="btn btn-warning">modifier</a>
                                    </td>
                                    <td>
                                        <a href="{{route('admin.categories.delete', ['id' => $cat->id])}}" onclick="delete()" class="btn btn-danger">retirer</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#cat_form").validate({
			...
			messages: {
				Name: "Indiquez un nom de categorie",
