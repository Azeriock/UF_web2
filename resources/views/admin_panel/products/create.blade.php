                        ...
                        <div class="card-body">
                            <a style="color:green;" href="{{route('admin.products')}}">
                                < Retour à la liste</a>
                                    ...
                                    <br>
                                    <img  id="imageHolder" src="" alt="ajouter une image" height="300" width="300"/>
                                    <br>
                                    ...
                                    <form class="forms-sample" method="post"  id="product_form">
                                        ...
                                        <input type="submit" name="saveButton" class="btn btn-success mr-2" id="saveButton" value="Creer"  />
                                    </form>
                                    @if($errors->any())
