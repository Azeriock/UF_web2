            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div class="add-to-cart">
                        <button type="submit" name="myButton" id="myButton" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Ajouter au panier</button>
                    </div>
                    </form>
...
<script>
    ...
    $(document).ready(function() {
		...
		$("#order_form").validate({
            ...
            document.getElementById("for_error").innerHTML = "<label class='error' style=' '>Choisissez une couleur</label>";
